...
== Deploy Cloud Tiering licenses to clusters in special configurations

ONTAP clusters in Tiering Mirror and MetroCluster configurations can't be licensed in the same manner as single-node and HA-configured clusters. You need to push a "child" license to these clusters for 
