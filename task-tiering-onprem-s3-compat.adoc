...
* An on-prem ONTAP cluster that's running ONTAP 9.8 or later, and a connection over a user-specified port to the S3-compatible object storage. link:task-discovering-ontap.html[Learn how to discover a cluster].
