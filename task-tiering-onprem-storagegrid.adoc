...
Licensing::
A Cloud Tiering license isn't required in your BlueXP account, nor is a FabricPool license required on the ONTAP cluster, when tiering data to StorageGRID.
