...
* An on-prem ONTAP cluster that's running ONTAP 9.4 or later, and a connection over a user-specified port to StorageGRID. link:task-discovering-ontap.html[Learn how to discover a cluster].
