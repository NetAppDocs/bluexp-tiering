...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-aws.html[Deploying a Connector in AWS^]
...
+
** An HTTPS connection over port 443 to the Cloud Tiering service and to your S3 object storage (https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-set-up-networking-aws.html#endpoints-contacted-for-day-to-day-operations[see the list of endpoints^])
