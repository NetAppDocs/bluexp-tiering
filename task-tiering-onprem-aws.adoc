...
+
If you want to use a different prefix for buckets for additional clusters in this BlueXP account, you can add another line with the prefix for other buckets. For example:
+
