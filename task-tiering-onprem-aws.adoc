...
* An on-prem ONTAP cluster that's running ONTAP 9.2 or later and has an HTTPS connection to Amazon S3. link:task-discovering-ontap.html[Learn how to discover a cluster].
