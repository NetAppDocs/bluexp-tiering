...
Cloud Tiering licenses can now be shared with your clusters that are in Tiering Mirror and MetroCluster configurations. This makes it easier to use the "floating" Cloud Tiering licenses on more of your clusters. https://docs.netapp.com/us-en/cloud-manager-tiering/task-licensing-cloud-tiering.html#deploy-cloud-tiering-licenses-to-clusters-in-special-configurations[See how to license these types of clusters.]
