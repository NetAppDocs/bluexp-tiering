...
=== Drag and drop to enable Cloud Tiering to Azure Blob and Google Cloud Storage

If the Azure Blob or Google Cloud Storage tiering destination exists as a working environment on the Canvas, you can drag your on-prem ONTAP working environment onto the destination to initiate the Tiering setup wizard.
