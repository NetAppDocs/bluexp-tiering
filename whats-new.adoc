...
=== Use a custom prefix for the bucket name where tiering data is stored
...
=== Now you can adjust the bandwidth to upload inactive data to object storage
