...
. From the Advanced Settings page, drag the object store you want to use to the location for the mirror object store.
+
...
. From the Advanced Settings page, click the menu icon for the aggregate and select *Swap Destinations*.
+
...
. From the Advanced Settings page, click the menu icon for the aggregate and select *Unmirror Object Store*.
+
