...
For more details about the value that Cloud Tiering provides, https://bluexp.netapp.com/cloud-tiering[check out the Cloud Tiering page on the BlueXP website^].

TIP: Cloud Volumes ONTAP systems are read-only from Cloud Tiering. https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-tiering.html[You set up tiering for Cloud Volumes ONTAP systems from the working environment in BlueXP^].
