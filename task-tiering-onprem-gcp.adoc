...
* An on-prem ONTAP cluster that's running ONTAP 9.6 or later and has an HTTPS connection to Google Cloud Storage. link:task-discovering-ontap.html[Learn how to discover a cluster].
